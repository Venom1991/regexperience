...
#define SYNTACTIC_ANALYSIS_TYPE_LEXEME (lexeme_get_type ())
#define lexeme_new(...) (g_object_new (SYNTACTIC_ANALYSIS_TYPE_LEXEME, ##__VA_ARGS__, NULL))

G_DECLARE_FINAL_TYPE (Lexeme, lexeme, SYNTACTIC_ANALYSIS, LEXEME, GObject)
