...
Transition *
create_deterministic_unconditional_transition (State *output_state)
{
...
Transition *
create_mealy_unconditional_transition (State    *output_state,
                                       gpointer  output_data)
{
  return mealy_transition_new (PROP_TRANSITION_EQUALITY_CONDITION_TYPE, EQUALITY_CONDITION_TYPE_ANY,
                               PROP_DETERMINISTIC_TRANSITION_OUTPUT_STATE, output_state,
                               PROP_MEALY_TRANSITION_OUTPUT_DATA, output_data);
}
